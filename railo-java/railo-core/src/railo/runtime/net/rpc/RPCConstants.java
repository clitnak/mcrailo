...
public final class RPCConstants {
	...
	//public static final QName COMPONENT = new QName("http://rpc.xml.cfml","Component");
	public static QName QUERY_QNAME=new QName("http://rpc.xml.cfml","QueryBean");
	//public static QName ARRAY_QNAME=new QName("http://rpc.xml.cfml","Array");
